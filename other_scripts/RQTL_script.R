...
#(11.3) create csv files for the recombination frequencies for each chromosome
...
#(11.4) create csv files for the recombination frequencies LOD scores

##########################################################################################
for(i in 1:nchr(cross)){
file<-paste("6_rf_lod_ch_", i, ".csv")
rf <- pull.rf(subset(cross, chr=i), what="lod")
write.csv(file=file, rf)
}
##########################################################################################
